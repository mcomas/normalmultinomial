...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(ddirmult(x, alpha));
    return __result;
END_RCPP
}
// dm_iter
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< arma::mat >::type X(XSEXP);
    Rcpp::traits::input_parameter< arma::vec >::type alpha(alphaSEXP);
    __result = Rcpp::wrap(dm_iter(X, alpha));
    return __result;
END_RCPP
}
// c_dm_fit
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(c_dm_fit(X, eps, maxiter));
    return __result;
END_RCPP
}
// mvf_multinom_const
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< arma::mat >::type sigma_ilr(sigma_ilrSEXP);
    Rcpp::traits::input_parameter< arma::mat >::type Z(ZSEXP);
    __result = Rcpp::wrap(expectedMonteCarlo2(x, mu_ilr, sigma_ilr, Z));
    return __result;
END_RCPP
}
// expectedMonteCarlo3
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(expectedMonteCarlo3(x, mu_ilr, sigma_ilr, Z, mu_exp));
    return __result;
END_RCPP
}
// expectedMonteCarlo4
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(expectedMonteCarlo4(x, mu_ilr, sigma_ilr, Z, mu_exp, sigma_exp));
    return __result;
END_RCPP
}
